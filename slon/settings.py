"""
Django settings for slon project.
...
SECRET_KEY = '*2z(^r=)8#4m93wz*_5=i2)pv9b-m@9mna1(orkd=h$@9^&8p7'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'landing.context_processors.context_info',
            ],
        },
    },
]

WSGI_APPLICATION = 'slon.wsgi.application'
...
IMAGEFIT_PRESETS = {
    'news': {'width': 300, 'height': 300, 'crop': True},
    'album': {'width': 540, 'height': 300, 'crop': True},
    'image': {'width': 330, 'height': 185, 'crop': True},
